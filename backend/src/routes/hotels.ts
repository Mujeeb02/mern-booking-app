...
const stripe = new Stripe("sk_test_51P3oRESIzk3deguqtgCzSR7luhLX4o4p4HJhKi1KtH3heGRdny9OatgsrkAlMIOAq31s3dkqIpXhglZoqetboxky00QdkqRUjY");
    ...
    async (req: Request, res: Response) => {
        try {
            ...
            const paymentIntent = await stripe.paymentIntents.create({
                amount: totalCost * 100, // Stripe requires the amount in cents
                currency: "INR",
                metadata: {
                    hotelId,
                    userId: req.userId,
